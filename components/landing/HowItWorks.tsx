...
const STEPS = [
  {
    ...
    description:
      "Describe how you want your smart contract to be designed — choose libraries, files, and architecture to generate.",
  },
  {
    icon: Sparkles,
    title: "We Generate Everything",
    description:
      "Your smart contracts, UI, and files are auto-generated. Edit and iterate easily using our built-in code editor and AI assistant.",
  },
  {
    icon: ShieldCheck,
    title: "Audit & Deploy",
    description:
      "Audit your contracts with verified auditors on the marketplace, then deploy securely onchain with one click.",
  },
];
  ...
  return (
    <section className="w-full bg-neutral-50 py-12 sm:py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <h2 className="text-3xl sm:text-4xl font-bold text-center mb-10 sm:mb-14 md:mb-16">
          How it works
        </h2>
            ...
            return (
              ...
              >
                ...
                <div className="hidden md:block absolute -top-4 -left-4 sm:-top-5 sm:-left-5 text-white font-bold h-9 sm:h-10 py-1 pt-1.5 sm:pt-2 rounded-lg">
                  <Badge className="p-1 px-2 bg-purple-500/90 text-[10px] sm:text-xs">
                    Step {index + 1}
                  </Badge>
                </div>
              </div>
